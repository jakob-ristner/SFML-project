...
bool Collider::checkCollision(CollisionBox *other, sf::Vector2f& direction, float push) {
...
bool SpriteCollider::checkCollision(CollisionBox *other, sf::Vector2f& direction, float push) {
    sf::Vector2f otherPosition = (*other).getPosition();
    sf::Vector2f otherHalfSize = (*other).getHalfSize();
    sf::Vector2f thisPosition = getPosition();
    sf::Vector2f thisHalfSize = getHalfSize();
